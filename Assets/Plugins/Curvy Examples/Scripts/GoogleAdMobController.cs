...
public class GoogleAdMobController : MonoBehaviour
{
    ...
    public void RequestAndLoadRewardedAd()
    {
        ...
        string adUnitId = "unused";
#elif UNITY_ANDROID
        string adUnitId = rewardedID_Android;
#elif UNITY_IPHONE
        string adUnitId = rewardedID_IOS;
#else
        string adUnitId = "unexpected_platform";
#endif
        ...
        rewardedAd.OnUserEarnedReward += (sender, args) =>
        {
            ...
            FindObjectOfType<TestScript>().ShowRewarded();
    ...
    public void RequestAndLoadRewardedInterstitialAd()
    {
        ...
        string adUnitId = "unused";
#elif UNITY_ANDROID
        string adUnitId = rewardedInterstitialID_Android;
#elif UNITY_IPHONE
            string adUnitId = rewardedInterstitialID_IOS;
#else
            string adUnitId = "unexpected_platform";
#endif
